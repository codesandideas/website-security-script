...
#
# Usage: sudo bash web-security-scanner.sh /path/to/website
#
...
show_usage() {
    ...
    echo "  --email <address>   Recipient email (passed to webhook)"
    echo "  --help              Show this help message"
    echo ""
    echo "Examples:"
    echo "  sudo bash $0 /var/www/html"
    echo "  sudo bash $0 /var/www/html --webhook https://yourdomain.com/security-receiver.php --api-key SECRET --email admin@site.com"
    exit 0
}
